...
function Result({ variant }) {
  return (
    <div className="result">
      ...
      <h2>Вы отгадали {variant} ответа из {questions.length}</h2>
      <a href="/">
...
function App() {
  ...
  return (
    <div className="App">
      {step !== questions.length ? <Game step={step} question={question} onClickVariant={onClickVariant} /> : <Result variant={variant} />}
    </div>
  );
}
